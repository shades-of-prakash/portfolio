...
export default function Songs() {
  const currentSong = {
    title: "Damn Right",
    artist: "Jennie",
    album: "The Idol Episode 2 (Music from the HBO Original Series)",
    cover: Image,
  };
  ...
  return (
    <div className="flex flex-col gap-6 p-6 w-full text-white">
      ...
      <div className="flex md:flex-col flex-col-reverse lg:flex-row gap-6 w-full items-stretch">
        ...
        {/* Now Playing */}
        {/* <div className="lg:w-1/3 w-full h-full bg-green-600 text-white rounded-xl border border-green-700 shadow-lg p-6 flex flex-col justify-between">
...
<div className="lg:w-1/3 w-full h-full bg-green-600 text-white rounded-xl border border-green-700 shadow-lg p-6 flex flex-col justify-between">
  ...
  <div className="flex flex-col gap-1 text-black mt-4">
    ...
    <span className="text-lg text-black/90">{currentSong.artist}</span>
    <span className="text-sm italic text-black/70">{currentSong.album}</span>
  </div>
</div>
