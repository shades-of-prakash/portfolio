...
export default function Instruments() {
	...
	return (
		<div className="flex flex-col gap-3 w-screen h-auto md:p-6 p-3">
					...
					<ul className="flex flex-1 z-10 w-full">
						{items.map((item, index) => (
							<li
								...
								} flex flex-1 items-center justify-center rounded-full px-4 py-2 cursor-pointer relative hover:bg-green-600/20`}
