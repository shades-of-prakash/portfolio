...
const DADanimation = () => {
	...
	return (
		...
		>
			<div
				ref={subTestRef}
				className="h-full flex flex-row absolute will-change-transform overscroll-none"
				style={{ width: `${3 * 100}vw` }}
			>
				<div className="relative w-screen h-full bg-gradient-to-r from-green-600 to-green-800 flex items-center justify-center overflow-hidden">
					<div
						ref={imgWrapperRef}
